...
static struct stFpgaLocalbusConfig  s_FpgaLocalbusConfig [GN_FPGA_NUM] = 
{
	...
	{GN_FPGA_INDEX_IP_ASI_OUTPUT,	FPGA_IP_ASI_OUTPUT_BASE_ADDR, LOCALBUS_NCS2,	0},
};

#define AT91C_SMC2_NWS_1_CYCLE 0x01
...
static int FpgaLocabus_Config(int Index)
{
	...
	/* 0x10000代表16位，A0~A15，size就是这么大 */
	s_FpgaLocalbusConfig[Index].m_VirtualBaseAddr = (unsigned int)ioremap(s_FpgaLocalbusConfig[Index].m_PhyBaseAddr, 0x10000) ;
	...
	RSV[31]:	保留
	*/
	AT91_SYS->EBI_SMC2_CSR[s_FpgaLocalbusConfig[Index].m_CsrIndex] =  AT91C_SMC2_RWHOLD_2_CYCLE | AT91C_SMC2_DBW_16 | AT91C_SMC2_BAT | AT91C_SMC2_WSEN | AT91C_SMC2_NWS_1_CYCLE;
