...
MyLoadingWindow.prototype.ShowWindow = function(CountDown, bShowCount, bAutoHide, OnCloseScript)
{
    ...
    lTmpStr = "text-align:center;background:#666;position:fixed;z-index:1;top:" + lPadding + "px;left:" + lPadding + "px;width:" + (lWindowWidth - lPadding * 2) + "px;height:" + (lWindowHeight - lPadding * 2) + "px;";
    lTmpStr += "filter:alpha(Opacity=20);-moz-opacity:0.2;opacity: 0.2;";
    ...
    lTmpStr += "filter:alpha(Opacity=40);-moz-opacity:0.4;opacity: 0.4;";
    ...
    lTmpStr += "filter:alpha(Opacity=100);-moz-opacity:1.0;opacity: 1.0;";
