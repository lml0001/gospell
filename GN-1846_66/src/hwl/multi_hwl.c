...
#if defined(GN1866B)
	HANDLE32	m_pLt6911cRxHandle[MULT_MAX_CHN_NUM]; /* Lt6911c(4K) 接收 AD 模块 */
#endif
	HANDLE32	m_pSdiRxHandle[MULT_MAX_CHN_NUM]; /* SDI 接收 AD 模块 */
}HWL_Handle;
...
//edit by leonli	
#elif defined(GN1866B) || defined(GN1866)
	FPS_GpioCfgParam lCfgParam;

	lCfgParam.m_IsUseConfigDone = TRUE;
	lCfgParam.m_DataPinAddr.m_GpioIndex = HI_GPIO6;
	lCfgParam.m_DataPinAddr.m_Pin = HI_PIN4;
	lCfgParam.m_DclkPinAddr.m_GpioIndex = HI_GPIO6;
	lCfgParam.m_DclkPinAddr.m_Pin = HI_PIN2;
	lCfgParam.m_NStatusPinAddr.m_GpioIndex = HI_GPIO6;

	lCfgParam.m_NStatusPinAddr.m_Pin = HI_PIN7;
	lCfgParam.m_NConfigPinAddr.m_GpioIndex = HI_GPIO6;
	lCfgParam.m_NConfigPinAddr.m_Pin = HI_PIN5;
	lCfgParam.m_ConfigDonePinAddr.m_GpioIndex = HI_GPIO6;
	lCfgParam.m_ConfigDonePinAddr.m_Pin = HI_PIN6;
	lCfgParam.m_pUserParam = NULL;
...
{
		HWL_MainBoardVersion hw_version = MainBoard_Num;
		
		U32 lGpioIndex = HI_GPIO7;
		U32 lGpioPin = HI_PIN4;	

		HI_GpioSetup(lGpioIndex, lGpioPin, TRUE, TRUE);
		hw_version = HI_GpioGetValue(lGpioIndex, lGpioPin);
		return hw_version;
}
#endif
...
void HWL_FpgaSpiDebug(void)
{
	...
	DRL_DebugSetSpiHandle(lFspiHandle);
//DRL_ICPInitate();
	if (lFspiHandle) {
#if !defined(GN1866)
		...
		while(1)
		{
			GLOBAL_TRACE(("Read Chip ID!!!!\n"));
			Chip_ID = AUTHL_Fpga_ID();
			sleep(1);
		}
#else
		 AUTHL_Test();
...
//		{{HDMI_RX_GPIO_CPU, HI_GPIO5, HI_PIN5}, {HDMI_RX_GPIO_CPU, HI_GPIO5, HI_PIN4}, {HDMI_RX_GPIO_FPGA_EXT, 0, FSPI_EX_IO_0}},
//		{{HDMI_RX_GPIO_CPU, HI_GPIO7, HI_PIN6}, {HDMI_RX_GPIO_CPU, HI_GPIO7, HI_PIN5}, {HDMI_RX_GPIO_FPGA_EXT, 0, FSPI_EX_IO_6}}
//		};
//
//		/* scl,sda,wp */
//		HDMI_RxGpioPin plEepromPinList[MULT_MAX_CHN_NUM][3] = {
//			{{HDMI_RX_GPIO_CPU, HI_GPIO7, HI_PIN3}, {HDMI_RX_GPIO_CPU, HI_GPIO7, HI_PIN7}, {HDMI_RX_GPIO_FPGA_EXT, 0, FSPI_EX_IO_2}},
//			{{HDMI_RX_GPIO_CPU, HI_GPIO1, HI_PIN7}, {HDMI_RX_GPIO_CPU, HI_GPIO1, HI_PIN6}, {HDMI_RX_GPIO_FPGA_EXT, 0, FSPI_EX_IO_8}}
//		};
//
//
...
//{
//	for (i = 0; i < MULT_MAX_CHN_NUM; i++) {
//		GLOBAL_TRACE(("======i:%d MULT_MAX_CHN_NUM:%d\n", i, MULT_MAX_CHN_NUM));
//		lInitParam.m_Adv7612I2cSclPin.m_GpioType = plAdv7612PinList[i][0].m_GpioType;
//		lInitParam.m_Adv7612I2cSclPin.m_GpioIndex = plAdv7612PinList[i][0].m_GpioIndex;
//		lInitParam.m_Adv7612I2cSclPin.m_Pin = plAdv7612PinList[i][0].m_Pin;
//		lInitParam.m_Adv7612I2cSdaPin.m_GpioType = plAdv7612PinList[i][1].m_GpioType;
 ...
 void HWL_HdmiRxInit(void)
{
	...
	/* scl,sda,rst */
	HDMI_RxGpioPin plAdv7612PinList_V1[MULT_MAX_CHN_NUM][3] = {
		{{HDMI_RX_GPIO_CPU, HI_GPIO8, HI_PIN6}, {HDMI_RX_GPIO_CPU, HI_GPIO8, HI_PIN7}, {HDMI_RX_GPIO_FPGA_EXT, 0, FSPI_EX_IO_0}},
		{{HDMI_RX_GPIO_CPU, HI_GPIO7, HI_PIN6}, {HDMI_RX_GPIO_CPU, HI_GPIO7, HI_PIN5}, {HDMI_RX_GPIO_FPGA_EXT, 0, FSPI_EX_IO_6}}
	};

	/* scl,sda,wp */
	HDMI_RxGpioPin plEepromPinList_V1[MULT_MAX_CHN_NUM][3] = {
		{{HDMI_RX_GPIO_CPU, HI_GPIO7, HI_PIN3}, {HDMI_RX_GPIO_CPU, HI_GPIO7, HI_PIN7}, {HDMI_RX_GPIO_FPGA_EXT, 0, FSPI_EX_IO_2}},
		{{HDMI_RX_GPIO_CPU, HI_GPIO1, HI_PIN7}, {HDMI_RX_GPIO_CPU, HI_GPIO1, HI_PIN6}, {HDMI_RX_GPIO_FPGA_EXT, 0, FSPI_EX_IO_8}}
	};

	/* scl,sda,rst */
	HDMI_RxGpioPin plAdv7612PinList_V2[MULT_MAX_CHN_NUM][3] = {
		{{HDMI_RX_GPIO_CPU, HI_GPIO5, HI_PIN5}, {HDMI_RX_GPIO_CPU, HI_GPIO5, HI_PIN4}, {HDMI_RX_GPIO_FPGA_EXT, 0, FSPI_EX_IO_0}},
		{{HDMI_RX_GPIO_CPU, HI_GPIO7, HI_PIN6}, {HDMI_RX_GPIO_CPU, HI_GPIO7, HI_PIN5}, {HDMI_RX_GPIO_FPGA_EXT, 0, FSPI_EX_IO_6}}
	};

	/* scl,sda,wp */
	HDMI_RxGpioPin plEepromPinList_V2[MULT_MAX_CHN_NUM][3] = {
		{{HDMI_RX_GPIO_CPU, HI_GPIO7, HI_PIN3}, {HDMI_RX_GPIO_CPU, HI_GPIO7, HI_PIN7}, {HDMI_RX_GPIO_FPGA_EXT, 0, FSPI_EX_IO_2}},
		{{HDMI_RX_GPIO_CPU, HI_GPIO1, HI_PIN7}, {HDMI_RX_GPIO_CPU, HI_GPIO1, HI_PIN6}, {HDMI_RX_GPIO_FPGA_EXT, 0, FSPI_EX_IO_8}}
	};
	...
	hw_version = HWL_GetHwVersion();
	
	GLOBAL_TRACE(("===HDMI RX Initialize (hw_version :%d)===\n", hw_version));

	for (i = 0; i < MULT_MAX_CHN_NUM; i++) 
	{
		if (hw_version == MainBoard_V1)
		{	
			lInitParam.m_Adv7612I2cSclPin.m_GpioType = plAdv7612PinList_V1[i][0].m_GpioType;
			lInitParam.m_Adv7612I2cSclPin.m_GpioIndex = plAdv7612PinList_V1[i][0].m_GpioIndex;
			lInitParam.m_Adv7612I2cSclPin.m_Pin = plAdv7612PinList_V1[i][0].m_Pin;
			lInitParam.m_Adv7612I2cSdaPin.m_GpioType = plAdv7612PinList_V1[i][1].m_GpioType;
			lInitParam.m_Adv7612I2cSdaPin.m_GpioIndex = plAdv7612PinList_V1[i][1].m_GpioIndex;
			lInitParam.m_Adv7612I2cSdaPin.m_Pin = plAdv7612PinList_V1[i][1].m_Pin;
			lInitParam.m_Adv7612RstPin.m_GpioType = plAdv7612PinList_V1[i][2].m_GpioType;
			lInitParam.m_Adv7612RstPin.m_GpioIndex = plAdv7612PinList_V1[i][2].m_GpioIndex;
			lInitParam.m_Adv7612RstPin.m_Pin = plAdv7612PinList_V1[i][2].m_Pin;

			lInitParam.m_EepromI2cSclPin.m_GpioType = plEepromPinList_V1[i][0].m_GpioType;
			lInitParam.m_EepromI2cSclPin.m_GpioIndex = plEepromPinList_V1[i][0].m_GpioIndex;
			lInitParam.m_EepromI2cSclPin.m_Pin = plEepromPinList_V1[i][0].m_Pin;
			lInitParam.m_EepromI2cSdaPin.m_GpioType = plEepromPinList_V1[i][1].m_GpioType;
			lInitParam.m_EepromI2cSdaPin.m_GpioIndex = plEepromPinList_V1[i][1].m_GpioIndex;
			lInitParam.m_EepromI2cSdaPin.m_Pin = plEepromPinList_V1[i][1].m_Pin;
			lInitParam.m_EepromWpPin.m_GpioType = plEepromPinList_V1[i][2].m_GpioType;
			lInitParam.m_EepromWpPin.m_GpioIndex = plEepromPinList_V1[i][2].m_GpioIndex;
			lInitParam.m_EepromWpPin.m_Pin = plEepromPinList_V1[i][2].m_Pin;


		}
		else
		{
			lInitParam.m_Adv7612I2cSclPin.m_GpioType = plAdv7612PinList_V2[i][0].m_GpioType;
			lInitParam.m_Adv7612I2cSclPin.m_GpioIndex = plAdv7612PinList_V2[i][0].m_GpioIndex;
			lInitParam.m_Adv7612I2cSclPin.m_Pin = plAdv7612PinList_V2[i][0].m_Pin;
			lInitParam.m_Adv7612I2cSdaPin.m_GpioType = plAdv7612PinList_V2[i][1].m_GpioType;
			lInitParam.m_Adv7612I2cSdaPin.m_GpioIndex = plAdv7612PinList_V2[i][1].m_GpioIndex;
			lInitParam.m_Adv7612I2cSdaPin.m_Pin = plAdv7612PinList_V2[i][1].m_Pin;
			lInitParam.m_Adv7612RstPin.m_GpioType = plAdv7612PinList_V2[i][2].m_GpioType;
			lInitParam.m_Adv7612RstPin.m_GpioIndex = plAdv7612PinList_V2[i][2].m_GpioIndex;
			lInitParam.m_Adv7612RstPin.m_Pin = plAdv7612PinList_V2[i][2].m_Pin;

			lInitParam.m_EepromI2cSclPin.m_GpioType = plEepromPinList_V2[i][0].m_GpioType;
			lInitParam.m_EepromI2cSclPin.m_GpioIndex = plEepromPinList_V2[i][0].m_GpioIndex;
			lInitParam.m_EepromI2cSclPin.m_Pin = plEepromPinList_V2[i][0].m_Pin;
			lInitParam.m_EepromI2cSdaPin.m_GpioType = plEepromPinList_V2[i][1].m_GpioType;
			lInitParam.m_EepromI2cSdaPin.m_GpioIndex = plEepromPinList_V2[i][1].m_GpioIndex;
			lInitParam.m_EepromI2cSdaPin.m_Pin = plEepromPinList_V2[i][1].m_Pin;
			lInitParam.m_EepromWpPin.m_GpioType = plEepromPinList_V2[i][2].m_GpioType;
			lInitParam.m_EepromWpPin.m_GpioIndex = plEepromPinList_V2[i][2].m_GpioIndex;
			lInitParam.m_EepromWpPin.m_Pin = plEepromPinList_V2[i][2].m_Pin;
		...
		lInitParam.m_pUserParam = NULL;
#if defined GN1866B	
		lInitParam.m_HdmiRxType = HDMI_RX_ADV7612;
#endif
...
BOOL Probe_Hdmi_Board(void)
{
	...
	for (i = 0; i < MULT_MAX_CHN_NUM; i++) 
	{
		 result = HDMI_Probe(s_HWLHandle.m_pHdmiRxHandle[i]);
		 if (TRUE == result)
		 {
		 	return TRUE;
		 }
...
//////////////////////////Begin LT6911C///////////////////////////////////////////////////////////////
#if defined(GN1866B)
HANDLE32 plLt6911cRxHandle[4] = {NULL};
void HWLL_Lt6911cDebugLoop(void *pParam) 
{
	S32 i;
	while(1) {
		HDMI_RxStatusParam lStatusParam;
		for (i = 0; i < MULT_MAX_CHN_NUM; i++) {
			if (plLt6911cRxHandle[i]) {
				HDMI_Lt6911cRxGetStatus(plLt6911cRxHandle[i], &lStatusParam);
				GLOBAL_TRACE(("HDMI[%d] Connected:%d Lock:%d VidStandard:%d AudSample:%d\n", i, 
					lStatusParam.m_HdmiIsConnected, lStatusParam.m_SignalIsLocked, lStatusParam.m_VideoStandard, lStatusParam.m_AudioSample));
			}
			sleep(1);
		}
	}
...
void HWL_Lt6911cRxDebug(void)
{
	...
	/* scl,sda,rst */
	HDMI_RxGpioPin plLt6911cPinList[MULT_MAX_CHN_NUM][3] = {
		{{HDMI_RX_GPIO_CPU, HI_GPIO7, HI_PIN6}, {HDMI_RX_GPIO_CPU, HI_GPIO7, HI_PIN5}, {HDMI_RX_GPIO_FPGA_EXT, 0, FSPI_EX_IO_6}},
		{{HDMI_RX_GPIO_CPU, HI_GPIO1, HI_PIN7}, {HDMI_RX_GPIO_CPU, HI_GPIO1, HI_PIN6}, {HDMI_RX_GPIO_FPGA_EXT, 0, FSPI_EX_IO_9}}
	};
	...
	/* lt6911c_sta */
	HDMI_RxGpioPin plLt6911cStaList[MULT_MAX_CHN_NUM] = {
		{HDMI_RX_GPIO_CPU, HI_GPIO12, HI_PIN4},
		{HDMI_RX_GPIO_CPU, HI_GPIO12, HI_PIN7}
	};
	
	for (i = 0; i < MULT_MAX_CHN_NUM; i++) 
	{
		lInitParam.m_LT6911CI2cSclPin.m_GpioType = plLt6911cPinList[i][0].m_GpioType;
		lInitParam.m_LT6911CI2cSclPin.m_GpioIndex = plLt6911cPinList[i][0].m_GpioIndex;
		lInitParam.m_LT6911CI2cSclPin.m_Pin = plLt6911cPinList[i][0].m_Pin;
		lInitParam.m_LT6911CI2cSdaPin.m_GpioType = plLt6911cPinList[i][1].m_GpioType;
		lInitParam.m_LT6911CI2cSdaPin.m_GpioIndex = plLt6911cPinList[i][1].m_GpioIndex;
		lInitParam.m_LT6911CI2cSdaPin.m_Pin = plLt6911cPinList[i][1].m_Pin;
		lInitParam.m_LT6911CRstPin.m_GpioType = plLt6911cPinList[i][2].m_GpioType;
		lInitParam.m_LT6911CRstPin.m_GpioIndex = plLt6911cPinList[i][2].m_GpioIndex;
		lInitParam.m_LT6911CRstPin.m_Pin = plLt6911cPinList[i][2].m_Pin;

		lInitParam.m_HdmiHpdPin.m_GpioType = plHpdPinList[i].m_GpioType;
		lInitParam.m_HdmiHpdPin.m_GpioIndex = plHpdPinList[i].m_GpioIndex;
		lInitParam.m_HdmiHpdPin.m_Pin = plHpdPinList[i].m_Pin;
			
		lInitParam.m_LT6911CStaPin.m_GpioType = plLt6911cStaList[i].m_GpioType;
		lInitParam.m_LT6911CStaPin.m_GpioIndex = plLt6911cStaList[i].m_GpioIndex;
		lInitParam.m_LT6911CStaPin.m_Pin = plLt6911cStaList[i].m_Pin;
		...
		lInitParam.m_pUserParam = NULL;
		lInitParam.m_HdmiRxType = HDMI_RX_LT6911C;
		GLOBAL_TRACE(("HDMI_Rx Module[%d] Init...\n", i));
		if ((plLt6911cRxHandle[i] = HDMI_RxCreate(&lInitParam)) == NULL) 
		{
			GLOBAL_TRACE(("HDMI_RxCreate Failed!\n"));
		}
		GLOBAL_TRACE(("======i:%d MULT_MAX_CHN_NUM:%d\n", i, MULT_MAX_CHN_NUM));
		//HDMI_Lt6911cDownloadEdid(plLt6911cRxHandle[i], HDMI_RX_EDID_PCM);
	}

	GLOBAL_TRACE(("===HDMI RX Debug===\n"));
	PL_TaskCreate(1024 * 1024, HWLL_Lt6911cDebugLoop, TRUE, NULL);
	if (0)
	{ // GPIO ��֤
		U32 lGpioIndex = HI_GPIO12;
		U32 lGpioPin = HI_PIN6;
		U32 lRetVaule = 0;
		...
		while (1) {
			...
			GLOBAL_TRACE(("GPIO%d_%d: %d\n", lGpioIndex, lGpioPin, HI_GpioGetValue(lGpioIndex, lGpioPin)));
			sleep(1);*/
			lRetVaule = HI_GpioGetValue(lGpioIndex, lGpioPin);
			if (1)
			{
				GLOBAL_TRACE(("GPIO%d_%d: %d\n", lGpioIndex, lGpioPin, lRetVaule));
				sleep(1);
			}
...
static void HWL_Lt6911cRxInit(void)
{
	HDMI_RxInitParam lInitParam;
	S32 i;
...
//
	...
	/* hdmi_hpd */
	HDMI_RxGpioPin plLt6911cHpdPinList[MULT_MAX_CHN_NUM] = {
		{HDMI_RX_GPIO_FPGA_EXT, 0, FSPI_EX_IO_7},
		{HDMI_RX_GPIO_FPGA_EXT, 0, FSPI_EX_IO_10}
	};
	...
	for (i = 0; i < MULT_MAX_CHN_NUM; i++) 
	{
		...
		lInitParam.m_HdmiHpdPin.m_GpioType = plLt6911cHpdPinList[i].m_GpioType;
		lInitParam.m_HdmiHpdPin.m_GpioIndex = plLt6911cHpdPinList[i].m_GpioIndex;
		lInitParam.m_HdmiHpdPin.m_Pin = plLt6911cHpdPinList[i].m_Pin;
		...
		GLOBAL_TRACE(("HDMI_Rx Module[%d] Init...\n", i));
		if ((s_HWLHandle.m_pLt6911cRxHandle[i] = HDMI_RxCreate(&lInitParam)) == NULL) 
		{
			GLOBAL_TRACE(("HDMI_RxCreate Failed!\n"));
		}
	}
...
static void HWL_HdmiRxLt6911cTerminate(void)
{
	S32 i;

	for (i = 0; i < MULT_MAX_CHN_NUM; i++) {
		if (s_HWLHandle.m_pLt6911cRxHandle[i]) {
			HDMI_RxDestroy(s_HWLHandle.m_pLt6911cRxHandle[i]);
			s_HWLHandle.m_pLt6911cRxHandle[i] = NULL;
		}
	}
}
...
BOOL Probe_HdmiLt6911c_Board(void)
{
	...
	for (i = 0; i < MULT_MAX_CHN_NUM; i++) 
	{
		GLOBAL_TRACE(("Probe Slot %d\n", i));
		if (TRUE == HDMI_Lt6911c_Probe(s_HWLHandle.m_pLt6911cRxHandle[i]))
		{
			GLOBAL_TRACE(("Slot %d, LT6911C Detected OK!\n", i));
			lRet = TRUE;
		}
		else
		{
			GLOBAL_TRACE(("Slot %d, LT6911C Detected Failed!\n", i));
		}
	}
...
BOOL HWL_LT6911cDownloadProgram(void)
{
	...
	for (i = 0; i < MULT_MAX_CHN_NUM; i++) 
	{
		if (!HDMI_Lt6911cDownloadProgram(s_HWLHandle.m_pLt6911cRxHandle[i]))
		{
			return FALSE;
		}
...
BOOL HWL_LT6911cReset(HANDLE32 Handle, S32 ChnIndex)
{
	...
	lEdidType = plHandle->m_EdidInfo.m_EdidType[i];
	/* LT6911C ��λ */
	if (!HDMI_Lt6911cReset(s_HWLHandle.m_pLt6911cRxHandle[i]))
	{
		return FALSE;
	}
	/*set LT6911C EDID*/
	if (!HWL_HdmiRxDownloadEdid(i, lEdidType))
	{
		return FALSE;	
	}
	return TRUE;
...
BOOL HWL_HdmiRxDownloadEdid(S32 ChnIndex, S32 EdidType)
{
	if (HWL_Get_BoardType() == INTERFACE_BOARD_HDMI)
	{
		return HDMI_RxDownloadEdid(s_HWLHandle.m_pHdmiRxHandle[ChnIndex], EdidType);
	}
	else if (HWL_Get_BoardType() == INTERFACE_BOARD_4K)
	{
		return HDMI_Lt6911cDownloadEdid(s_HWLHandle.m_pLt6911cRxHandle[ChnIndex], EdidType);
	} 
}
...
BOOL HWL_HdmiRxGetStatus(S32 ChnIndex, HDMI_RxStatusParam *pStatus)
{
	...
	{
		return HDMI_Lt6911cRxGetStatus(s_HWLHandle.m_pLt6911cRxHandle[ChnIndex], pStatus);
	} 
}
#endif
...
//TODO:changed by leonli
#if defined(GN1846) || defined(GN1866)
static S32 HWLL_SDIGpioGetValue(SPI_GpioPin GpioPin, S32 *pPinStatus, void *pUserPara)
{
		...
		{
			lStatus.m_StatTag = FSPI_STAT_EX_IO;
			lStatus.m_StatParam.m_ExIo.m_IoIndex = GpioPin.m_Pin;
			FSPI_GetStatus(lFspiHandle, &lStatus);
			return lStatus.m_StatParam.m_ExIo.m_IoLvl;
		}
		return 0;
...
static BOOL HWLL_SDIGpioSetup(SPI_GpioPin GpioPin, S32 PinStatus, void *pUserPara)
{
	BOOL  ret = FALSE;
	FSPI_ConfigParam lCfgParam;
	HANDLE32 lFspiHandle = FSPI_GetHandle();
	...
	{
		lCfgParam.m_CfgTag = FSPI_CFG_EX_IO;
		lCfgParam.m_CfgParam.m_ExIo.m_IoIndex = GpioPin.m_Pin;
		lCfgParam.m_CfgParam.m_ExIo.m_IoDir = 0;
		lCfgParam.m_CfgParam.m_ExIo.m_IoLvl = 1;
		ret = FSPI_SetParam(lFspiHandle, &lCfgParam);
	}

	return ret;
}

static BOOL HWLL_SDIGpioSetValue(SPI_GpioPin GpioPin, S32 PinStatus, void *pUserPara)
{
	BOOL  ret = FALSE;
	FSPI_ConfigParam lCfgParam;
	HANDLE32 lFspiHandle = FSPI_GetHandle();
	...
	if (lFspiHandle) 
	{
		...
		lCfgParam.m_CfgParam.m_ExIo.m_IoIndex = GpioPin.m_Pin;
		lCfgParam.m_CfgParam.m_ExIo.m_IoDir = 0;
		lCfgParam.m_CfgParam.m_ExIo.m_IoLvl = PinStatus;
		ret = FSPI_SetParam(lFspiHandle, &lCfgParam);
	}
...
static S32 HWL_SDI_Write(HANDLE32 Handle, U16 RegAddr, U16 RegData, U32 dataLen, void *pUserPara)
{	
	GS2970_Handle *plHandle = (GS2970_Handle *)Handle;
	

	if (plHandle->m_GS2970SpiHandle == NULL)
	{
		return -1;
	}

    if (SPI_SDI_GpioWrite(plHandle->m_GS2970SpiHandle, RegAddr, 2, RegData) != dataLen) 
	{
        GLOBAL_TRACE(("HWL_SDI_Write Err!\n"));
        return -1;
    }
...
static S32 HWL_SDI_Read(HANDLE32 Handle, U16 RegAddr, U16 *pRegData, U32 dataLen, void *pUserPara)
{
    S32 lRet;
	GS2970_Handle *plHandle = (GS2970_Handle *)Handle;
    ...
    SPI_SDI_GpioRead(plHandle->m_GS2970SpiHandle, RegAddr, 2, pRegData);

    return TRUE;
}

S32 HWL_LEncoderViMode2Gs2970ViMode(S32 EncoderVideoFormat)
{
	switch(EncoderVideoFormat)
	{
		case  VI_MODE_NTSC:
			return GS2970_VID_FMT_720_480_60I;
			
		case VI_MODE_PAL:
			return GS2970_VID_FMT_720_576_50I;
			
		case VI_MODE_720P_50:
			return GS2970_VID_FMT_1280_720_50P;
			
		case VI_MODE_720P_5994:
			return GS2970_VID_FMT_1280_720_59_94P;
			
		case VI_MODE_720P_60:
			return GS2970_VID_FMT_1280_720_60P;
			
		case VI_MODE_1080I_50:
			return GS2970_VID_FMT_1920_1080_50I;
			
		case VI_MODE_1080I_5994:
			return GS2970_VID_FMT_1920_1080_59_94I;
			
		case VI_MODE_1080I_60:
			return GS2970_VID_FMT_1920_1080_60I;
			
		case VI_MODE_1080P_50:
			return GS2970_VID_FMT_1920_1080_50P;
			
		case VI_MODE_1080P_5994:
			return GS2970_VID_FMT_1920_1080_59_94P;
			
		case VI_MODE_1080P_60:
			return GS2970_VID_FMT_1920_1080_60P;
...
S32 HWL_Gs2970ViMode2LEncoderViMode(S32 Gs2970VideoFormat)
{
	switch(Gs2970VideoFormat)
	{
		case GS2970_VID_FMT_720_480_60I:
			return VI_MODE_NTSC;
			
		case GS2970_VID_FMT_720_576_50I:
			return VI_MODE_PAL;
			
		case GS2970_VID_FMT_1280_720_50P:
			return VI_MODE_720P_50;
			
		case GS2970_VID_FMT_1280_720_59_94P:
			return VI_MODE_720P_5994;
			
		case GS2970_VID_FMT_1280_720_60P:
			return VI_MODE_720P_60;
			
		case GS2970_VID_FMT_1920_1080_50I:
			return VI_MODE_1080I_50;
			
		case GS2970_VID_FMT_1920_1080_59_94I:
			return VI_MODE_1080I_5994;
			
		case GS2970_VID_FMT_1920_1080_60I:
			return VI_MODE_1080I_60;
			
		case GS2970_VID_FMT_1920_1080_50P:
			return VI_MODE_1080P_50;
			
		case GS2970_VID_FMT_1920_1080_59_94P:
			return VI_MODE_1080P_5994;
			
		case GS2970_VID_FMT_1920_1080_60P:
...
static char * Debug_GetStrByVidFmtVal(S32 VidFmt)
{
	switch (VidFmt)
	{
	case GS2970_VID_FMT_1920_1080_50P:
		return ("1920*1080P50");
	case GS2970_VID_FMT_1920_1080_59_94P:
		return ("1920*1080P59.94");
	case GS2970_VID_FMT_1920_1080_60P:
		return ("1920*1080P60");
	case GS2970_VID_FMT_1920_1080_50I:
		return ("1920*1080I50");
	case GS2970_VID_FMT_1920_1080_59_94I:
		return ("1920*1080I59.94");
	case GS2970_VID_FMT_1920_1080_60I:
		return ("1920*1080I60");
	case GS2970_VID_FMT_1280_720_50P:
		return ("1280*720P50");
	case GS2970_VID_FMT_1280_720_59_94P:
		return ("1280*720P59.94");
	case GS2970_VID_FMT_1280_720_60P:
		return ("1280*720P60");
	case GS2970_VID_FMT_720_576_50I:
		return ("720*576I50");
	case GS2970_VID_FMT_704_576_50I:
		return ("704*576I50");
	case GS2970_VID_FMT_640_576_50I:
		return ("640*576I50");
	case GS2970_VID_FMT_544_576_50I:
		return ("544*576I50");
	case GS2970_VID_FMT_480_576_50I:
		return ("480*576I50");
	case GS2970_VID_FMT_352_576_50I:
		return ("352*576I50");
	case GS2970_VID_FMT_352_288_50I:
		return ("352*288I50");
	case GS2970_VID_FMT_320_288_50I:
		return ("320*288I50");
	case GS2970_VID_FMT_720_480_60I: 
		return ("720*480I60");
	case GS2970_VID_FMT_704_480_60I: 
		return ("704*480I60");
	case GS2970_VID_FMT_640_480_60I: 
		return ("640*480I60");
	case GS2970_VID_FMT_544_480_60I: 
		return ("544*480I60");
	case GS2970_VID_FMT_480_480_60I:
		return ("480*480I60");
	case GS2970_VID_FMT_352_480_60I: 
		return ("352*480I60");
	case GS2970_VID_FMT_352_240_60I:
		return ("352*240I60");
	case GS2970_VID_FMT_320_240_60I: 
		return ("320*240I60");
	default:
...
static void Debug_PrintSdiStatusParam(S32 ChIndex, HWL_Gs2970StatusPara *pStatusParam)
{
	if(SDI_DEBUG)
	{
		printf ("\r\n--[CH - %d] SDI Status Print Start--\n", ChIndex);
		if (pStatusParam->m_LockStatus == GS2970_LOCKED)
		{
		...
		(pStatusParam->m_AudEmbedStatus.m_AudGrp1Status == GS2970_AUD_EMBED) ?
			printf ("  Audio Group1 Embed Status: EMBED\n") : printf ("  Audio Group1 Embed Status: NO EMBED\n");
		(pStatusParam->m_AudEmbedStatus.m_AudGrp2Status == GS2970_AUD_EMBED) ?
			printf ("  Audio Group2 Embed Status: EMBED\n") : printf ("  Audio Group2 Embed Status: NO EMBED\n");
		(pStatusParam->m_AudEmbedStatus.m_AudGrp3Status == GS2970_AUD_EMBED) ?
			printf ("  Audio Group3 Embed Status: EMBED\n") : printf ("  Audio Group3 Embed Status: NO EMBED\n");
		(pStatusParam->m_AudEmbedStatus.m_AudGrp4Status == GS2970_AUD_EMBED) ?
			printf ("  Audio Group4 Embed Status: EMBED\n") : printf ("  Audio Group4 Embed Status: NO EMBED\n");

		printf ("  Video Format: %s\n", Debug_GetStrByVidFmtVal(pStatusParam->m_VidFormat));

		printf ("-[CH - %d] SDI Status Print End--\r\n", ChIndex);
	}
}

BOOL HWL_SDIRxSetParam(S32 ChnIndex, HWL_SdiConfigParam *pCfgParam)
{
	BOOL	lRet = TRUE;
	HWL_Gs2970ConfigPara lConfigPara;

	pCfgParam->m_AudEmbedGroup = pCfgParam->m_AudEmbedGroup - 1;

	GLOBAL_SDI_DEBUG(("Embed Group: %d, IsAc3: %d, VidFormat:%d \n", 
												pCfgParam->m_AudEmbedGroup,
												pCfgParam->m_IsAc3,
												pCfgParam->m_VidFormat), SDI_DEBUG);
	GLOBAL_MEMSET(&lConfigPara, 0, sizeof(lConfigPara));

	/* 音频参数设置 */
	{
		S32 lIndex;
		lIndex = (pCfgParam->m_AudEmbedGroup + 1 - SDI_GRP1_CH_1_2)/ 2;/* 嵌入组的索引 */

		GLOBAL_SDI_DEBUG(("pCfgParam->m_AudEmbedGroup = %d \n",pCfgParam->m_AudEmbedGroup), SDI_DEBUG);

		lConfigPara.m_AudEmbedGroup.m_GrpA = lIndex + GS2970_SDI_AUD_GRP1;

		/* 由于组B不能与组A设置为一样，所以这里做一下处理 */

		if(lConfigPara.m_AudEmbedGroup.m_GrpA == GS2970_SDI_AUD_GRP1)
		{
			//GLOBAL_SDI_DEBUG(());
			lConfigPara.m_AudEmbedGroup.m_GrpB = GS2970_SDI_AUD_GRP2;
		}
		else
		{
			lConfigPara.m_AudEmbedGroup.m_GrpB = GS2970_SDI_AUD_GRP1;
		}

		GLOBAL_SDI_DEBUG(("GrpA = %d, GrpB = %d (Index:%d)\n",
											lConfigPara.m_AudEmbedGroup.m_GrpA,
											lConfigPara.m_AudEmbedGroup.m_GrpB,
											lIndex), SDI_DEBUG);

		/* 硬件是在非AC3的情况下，嵌入到AOUT1_2输出I2S的音频，
			AC3的情况下嵌入到AOUT7_8输出AES/EBU的音频到FPGA 
			设置是固定只用A组的1、2、3、4通道对应到输出，所以选择嵌入时只用修改组A的参数即可	
		*/
		if(pCfgParam->m_IsAc3 == FALSE)
		{
			lConfigPara.m_AudOutFormat.m_AoutFmt12 = GS2970_AOUT_FMT_I2S;
			lConfigPara.m_AudOutFormat.m_AoutFmt34 = GS2970_AOUT_FMT_I2S;
			lConfigPara.m_AudOutFormat.m_AoutFmt56 = GS2970_AOUT_FMT_I2S;
			lConfigPara.m_AudOutFormat.m_AoutFmt78 = GS2970_AOUT_FMT_I2S;

			if((pCfgParam->m_VidFormat >= VI_MODE_720P_50) && (pCfgParam->m_VidFormat <= VI_MODE_1080P_60)) /* HD */
			{
				lConfigPara.m_AudOutWordLen.m_AoutWordLen12 = GS2970_AUD_WORDLEN_24BIT;
				lConfigPara.m_AudOutWordLen.m_AoutWordLen34 = GS2970_AUD_WORDLEN_24BIT;
				lConfigPara.m_AudOutWordLen.m_AoutWordLen56 = GS2970_AUD_WORDLEN_24BIT;
				lConfigPara.m_AudOutWordLen.m_AoutWordLen78 = GS2970_AUD_WORDLEN_24BIT;
			}
			else /* SD*/
			{
				lConfigPara.m_AudOutWordLen.m_AoutWordLen12 = GS2970_AUD_WORDLEN_AUTO;
				lConfigPara.m_AudOutWordLen.m_AoutWordLen34 = GS2970_AUD_WORDLEN_AUTO;
				lConfigPara.m_AudOutWordLen.m_AoutWordLen56 = GS2970_AUD_WORDLEN_AUTO;
				lConfigPara.m_AudOutWordLen.m_AoutWordLen78 = GS2970_AUD_WORDLEN_AUTO;
			}

			if((pCfgParam->m_AudEmbedGroup + 1 - SDI_GRP1_CH_1_2)% 2 ==0 )
			{
				lConfigPara.m_AudOutSrc.m_AoutSrc1 = GS2970_GRPA_CH1;
				lConfigPara.m_AudOutSrc.m_AoutSrc2 = GS2970_GRPA_CH2;
			}
			else
			{
				lConfigPara.m_AudOutSrc.m_AoutSrc1 = GS2970_GRPA_CH3;
				lConfigPara.m_AudOutSrc.m_AoutSrc2 = GS2970_GRPA_CH4;
			}
			GLOBAL_SDI_DEBUG(("AoutSrc1 = %d, AoutSrc2 = %d (%d)\n",
													lConfigPara.m_AudOutSrc.m_AoutSrc1, 
													lConfigPara.m_AudOutSrc.m_AoutSrc2,
													((pCfgParam->m_AudEmbedGroup + 1 - SDI_GRP1_CH_1_2) % 2)), SDI_DEBUG);
		}
		else /* AC3 */
		{
			lConfigPara.m_AudOutFormat.m_AoutFmt12 = GS2970_AOUT_FMT_AES_EBU;
			lConfigPara.m_AudOutFormat.m_AoutFmt34 = GS2970_AOUT_FMT_AES_EBU;
			lConfigPara.m_AudOutFormat.m_AoutFmt56 = GS2970_AOUT_FMT_AES_EBU;
			lConfigPara.m_AudOutFormat.m_AoutFmt78 = GS2970_AOUT_FMT_AES_EBU;

			lConfigPara.m_AudOutWordLen.m_AoutWordLen12 = GS2970_AUD_WORDLEN_16BIT;
			lConfigPara.m_AudOutWordLen.m_AoutWordLen34 = GS2970_AUD_WORDLEN_16BIT;
			lConfigPara.m_AudOutWordLen.m_AoutWordLen56 = GS2970_AUD_WORDLEN_16BIT;
			lConfigPara.m_AudOutWordLen.m_AoutWordLen78 = GS2970_AUD_WORDLEN_16BIT;

			if ((pCfgParam->m_AudEmbedGroup + 1 - SDI_GRP1_CH_1_2) % 2 == 0)
			{
				lConfigPara.m_AudOutSrc.m_AoutSrc7= GS2970_GRPA_CH1;
				lConfigPara.m_AudOutSrc.m_AoutSrc8 = GS2970_GRPA_CH2;
			}
			else
			{
				lConfigPara.m_AudOutSrc.m_AoutSrc7 = GS2970_GRPA_CH3;
				lConfigPara.m_AudOutSrc.m_AoutSrc8 = GS2970_GRPA_CH4;
			}

			GLOBAL_SDI_DEBUG(("AoutSrc7 = %d, AoutSrc8 = %d \n", 
														lConfigPara.m_AudOutSrc.m_AoutSrc7, 
														lConfigPara.m_AudOutSrc.m_AoutSrc8), SDI_DEBUG);
		}
	}

	/* 视频参数处理 */
	{
		lConfigPara.m_VidOutFormatSel = HWL_LEncoderViMode2Gs2970ViMode(pCfgParam->m_VidFormat);
		GLOBAL_SDI_DEBUG(("VidOutFormatSel = %d \n", lConfigPara.m_VidOutFormatSel), SDI_DEBUG);
	}

	return HWL_Gs2970SetPara(s_HWLHandle.m_pSdiRxHandle[ChnIndex], &lConfigPara, NULL);
}

/*AudEmbedGroup 从SDI_GRP1_CH_1_2 到SDI_GRP4_CH_15_16*/
BOOL HWL_SDIRxGetStatus(S32 ChnIndex, HWL_SdiStatusParam *pSdiStatusPara, S32 AudEmbedGroup)
{
	BOOL lRet = TRUE;
	HWL_Gs2970StatusPara lStatusPara;

	if ((ChnIndex >= MULT_MAX_CHN_NUM) || (ChnIndex < 0))
	{
		return FALSE;
	}

	lRet = HWL_Gs2970GetPara(s_HWLHandle.m_pSdiRxHandle[ChnIndex],&lStatusPara,NULL);

	Debug_PrintSdiStatusParam(ChnIndex, &lStatusPara);

	pSdiStatusPara->m_LockStatus = lStatusPara.m_LockStatus;
	pSdiStatusPara->m_VidFormat = lStatusPara.m_VidFormat;
	
	switch ((AudEmbedGroup + 1 - SDI_GRP1_CH_1_2) / 2)
	{
		case 0:/* 组1 */
			pSdiStatusPara->m_IsAudEmbed = (lStatusPara.m_AudEmbedStatus.m_AudGrp1Status == GS2970_AUD_EMBED) ? TRUE : FALSE;
		break;
		case 1: /* 组2 */
			pSdiStatusPara->m_IsAudEmbed = (lStatusPara.m_AudEmbedStatus.m_AudGrp2Status == GS2970_AUD_EMBED) ? TRUE : FALSE;
			break;
		case 2: /* 组3 */
			pSdiStatusPara->m_IsAudEmbed = (lStatusPara.m_AudEmbedStatus.m_AudGrp3Status == GS2970_AUD_EMBED) ? TRUE : FALSE;
			break;
		case 3: /* 组4 */
			pSdiStatusPara->m_IsAudEmbed = (lStatusPara.m_AudEmbedStatus.m_AudGrp4Status == GS2970_AUD_EMBED) ? TRUE : FALSE;
			break;
		default:
			pSdiStatusPara->m_IsAudEmbed = FALSE;
		break;
	}
...
static void SdiSpi_SetValue(SPI_GpioPin *pPinAddr, S32 Value, void *pUserParam)
{
	HI_GpioSetValue(pPinAddr->m_GpioIndex, pPinAddr->m_Pin, Value);
}

static S32 SdiSpi_GetValue(SPI_GpioPin *pPinAddr, void *pUserParam)
{	
	return HI_GpioGetValue(pPinAddr->m_GpioIndex, pPinAddr->m_Pin);
}


static void SdiSpi_Setup(SPI_GpioPin *pPinAddr, BOOL IsInput, BOOL IsPullUp, void *pUserParam)
{
	HI_GpioSetup(pPinAddr->m_GpioIndex, pPinAddr->m_Pin, IsInput, IsPullUp);
}

static void HWL_SDIRxInit(void)
{
	S32 i = 0;
	HWL_Gs2970EnvPara lInitParam;
#ifdef GN1846

	/* SCK, SDAOut, CS,SDAIn */
	HWL_SDI_GpioPin plSDIPinList[MULT_MAX_CHN_NUM][4] =
	{
		{{HI_GPIO14, HI_PIN5}, {HI_GPIO14, HI_PIN4}, {HI_GPIO14, HI_PIN7}, {HI_GPIO14, HI_PIN6}},
		{{HI_GPIO10, HI_PIN1}, {HI_GPIO10, HI_PIN0}, {HI_GPIO24, HI_PIN0}, {HI_GPIO24, HI_PIN1}},
		{{HI_GPIO12, HI_PIN6}, {HI_GPIO12, HI_PIN5}, {HI_GPIO19, HI_PIN7}, {HI_GPIO19, HI_PIN6}},
		{{HI_GPIO9, HI_PIN4}, {HI_GPIO9, HI_PIN5}, {HI_GPIO9, HI_PIN2}, {HI_GPIO9, HI_PIN3}}
	};

	/* ResetPin*/
	HWL_SDI_GpioPin plResetPinList[MULT_MAX_CHN_NUM] = 
	{
		{0, FSPI_EX_IO_0},
		{0, FSPI_EX_IO_3},
		{0, FSPI_EX_IO_6},
	...
	/* 20/10BitPin */
	HWL_SDI_GpioPin pl20_10BitPinList[MULT_MAX_CHN_NUM] = 
	{
		{0, FSPI_EX_IO_2},
		{0, FSPI_EX_IO_5},
		{0, FSPI_EX_IO_8},
	...
	HWL_SDI_GpioPin plSDIPinList[MULT_MAX_CHN_NUM][4] = 
	{
			{{HI_GPIO7, HI_PIN3}, {HI_GPIO7, HI_PIN7}, {HI_GPIO5, HI_PIN5}, {HI_GPIO5, HI_PIN4}},
			{{HI_GPIO1, HI_PIN7}, {HI_GPIO1, HI_PIN6}, {HI_GPIO7, HI_PIN6}, {HI_GPIO7, HI_PIN5}}
	};
	...
	GLOBAL_TRACE(("===SDI RX Initialize===\n"));

	lInitParam.m_Gs2970ResetPulseWidth = 100;

	for(i = 0;i < MULT_MAX_CHN_NUM; i++)
	{
		/* SCK */
		lInitParam.m_InitParam.m_InitSpiParam.m_SckPin.m_GpioIndex= plSDIPinList[i][0].m_GpioIndex;
		lInitParam.m_InitParam.m_InitSpiParam.m_SckPin.m_Pin= plSDIPinList[i][0].m_Pin;

		/*SDA Out*/
		lInitParam.m_InitParam.m_InitSpiParam.m_SdaOutPin.m_GpioIndex = plSDIPinList[i][1].m_GpioIndex;
		lInitParam.m_InitParam.m_InitSpiParam.m_SdaOutPin.m_Pin = plSDIPinList[i][1].m_Pin;

		/* CS */
		lInitParam.m_InitParam.m_InitSpiParam.m_CsPin.m_GpioIndex = plSDIPinList[i][2].m_GpioIndex;
		lInitParam.m_InitParam.m_InitSpiParam.m_CsPin.m_Pin = plSDIPinList[i][2].m_Pin;

		/*SDA In */
		lInitParam.m_InitParam.m_InitSpiParam.m_SdaInPin.m_GpioIndex = plSDIPinList[i][3].m_GpioIndex;
		lInitParam.m_InitParam.m_InitSpiParam.m_SdaInPin.m_Pin = plSDIPinList[i][3].m_Pin;

		/* Reset */
		lInitParam.m_InitParam.m_ResetPin.m_GpioIndex = plResetPinList[i].m_GpioIndex;
		lInitParam.m_InitParam.m_ResetPin.m_Pin = plResetPinList[i].m_Pin;
		
		/* 20_10Bit */
		lInitParam.m_InitParam.m_20_10BitPin.m_GpioIndex = pl20_10BitPinList[i].m_GpioIndex;
		lInitParam.m_InitParam.m_20_10BitPin.m_Pin = pl20_10BitPinList[i].m_Pin;

		lInitParam.m_InitParam.m_InitSpiParam.m_GpioGetValueCB = SdiSpi_GetValue;
		lInitParam.m_InitParam.m_InitSpiParam.m_GpioSetValueCB = SdiSpi_SetValue;
		lInitParam.m_InitParam.m_InitSpiParam.m_GpioSetupCB = SdiSpi_Setup;

		lInitParam.m_ReadGpioCB = HWLL_SDIGpioGetValue;
		lInitParam.m_WriteGpioCB = HWLL_SDIGpioSetValue;
		lInitParam.m_SetupGpioCB = HWLL_SDIGpioSetup; /* 此处存在问题,GPIO没有初始化*/

		lInitParam.m_ReadRegCB = HWL_SDI_Read;
		lInitParam.m_WriteRegCB = HWL_SDI_Write;

		GLOBAL_TRACE(("SDI_Rx Module[%d] Init...\n", i));
		s_HWLHandle.m_pSdiRxHandle[i] = SDI_Create(&lInitParam);
		if(s_HWLHandle.m_pSdiRxHandle[i] == NULL)
		{
			GLOBAL_TRACE(("SDI_Create Failed!\n"));
		}

		//GLOBAL_TRACE(("--------------HWL_SDIRxInit------------------------\n"));
		//GLOBAL_TRACE(("--------------GOSPELL------------------------\n"));
		//GLOBAL_TRACE((" s_HWLHandle.m_pSdiRxHandle[%d] = 0x%x\r\n", i, s_HWLHandle.m_pSdiRxHandle[i]));
		//GLOBAL_TRACE(("---------------------------------------------------\n"));

		if(HWL_Gs2970DevInit(s_HWLHandle.m_pSdiRxHandle[i], NULL) == FALSE)
		{
			GLOBAL_TRACE(("SDI_Init Failed!\n"));
		}
	}

	GLOBAL_TRACE(("SDI init success!\n"));
}
...
BOOL Probe_SDI_Board(void)
{
	...
	GLOBAL_TRACE(("Probe_SDI_Board()\n"));

	for (i = 0; i < MULT_MAX_CHN_NUM; i++)
	{
		result = HWL_Probe_Gs2970(s_HWLHandle.m_pSdiRxHandle[i], NULL);
		 if (TRUE == result)
		 {
		 	return TRUE;
		 }
...
{
	S32 i;
	GLOBAL_TRACE(("Terminate_SDI_Board()\n"));
#if 0
	//for (i = 0; i < MULT_MAX_CHN_NUM; i++)
#else
    i = 3;
#endif
	{
		if(s_HWLHandle.m_pSdiRxHandle[i])
		{
			HWL_Gs2970Destroy(s_HWLHandle.m_pSdiRxHandle[i]);
			s_HWLHandle.m_pSdiRxHandle[i] = NULL;
		}
	}
}
/*手动复位(重新初始化SDI )*/
...
void Manual_Print_SDI_Reg(void)
{
	...
	GLOBAL_TRACE(("Print all of SDK Reg.\n"));

	for (i = 0; i < MULT_MAX_CHN_NUM; i++)
	{
		HWL_Gs2970_SPI_Read_All_Reg(s_HWLHandle.m_pSdiRxHandle[i], NULL, i);
#if defined(GN1866)
		usleep(1000);
#endif
	}
...
#if SDI_DEBUG
void HWL_SDIRxDebug(S32 ChnIndex)
{

	ChnIndex = 1; //only debug channel 2

	GLOBAL_TRACE(("-----------------------------------------------------\n"));
   HWL_Gs2970_SPI_Read_Debug(s_HWLHandle.m_pSdiRxHandle[ChnIndex], NULL);
   HWL_Gs2970_SPI_Write_Debug(s_HWLHandle.m_pSdiRxHandle[ChnIndex], NULL);
	GLOBAL_TRACE(("------------------------------------------------------\n"));

}

void HWL_SDI_Debug_Init(void)
{
	S32 i = 0;
	HWL_Gs2970EnvPara lInitParam;
	...
	HWL_SDI_GpioPin plSDIPinList[MULT_MAX_CHN_NUM][4] = 
   {
	...
	for (i = 0; i < MULT_MAX_CHN_NUM; i++) 
	{
       ...
       lInitParam.m_WriteRegCB = HWL_SDI_Write;
		...
		HWL_Gs2970_Reset_Debug(s_HWLHandle.m_pSdiRxHandle[i], NULL);
...
BOOL HWL_Initiate(S32 DeviceType)
{
...
#if defined(GN1846) || defined(GN1866)  || defined(GN1866B)
	else if (DeviceType == HWL_DEVICE_SIMU_1846)// leonli : workable?
	{
#if defined(GN1866)  || defined(GN1866B)  //hi3519v101芯片内部温度检测初始化
		PFC_System("himm 0x120A0110 0x60FF0000 > /dev/null");//循环检测，周期为255*2ms
		PFC_System("himm 0x120A0114 0x02C700AD > /dev/null");//上限：80，下限：-30
...
#if defined(GQ3650DR) || defined(GQ3710A) || defined(GQ3710B) || defined(GQ3655) || defined(GQ3760A) || defined(LR1800S) || defined(GM7000) || defined(GC1804C) || defined(GQ3760) || defined(GQ3768)|| defined(GC1804B)
	InitTunerIIC();
#endif
	...
	/* 探测输入底板类型*/
	HWL_Probe_InterfaceBoard();

	if (HWL_Get_BoardType() == INTERFACE_BOARD_UNKNOWN)
	{
		GLOBAL_PAUSE();
	}
	...
	{
		GLOBAL_TRACE(("Init 4K Board \n"));
		HWL_Lt6911cRxInit();
		HWL_LT6911cDownloadProgram();
...
#endif
#if defined(GN1866) || defined(GN1866B)
    lInitParam.m_SubNumPerCHN = 2;
#endif
	HWL_ENCODER_Initiate(&lInitParam);
#endif
	...
	*/
	...
	if (CHNIndex == 0) 
	{
		if (TsIndex == -1) 
		{
			for (i = 0; i < MULT_MAX_CHN_NUM; i++)
			{
				lRet += HWL_ENCODER_GetTsBitrate(0, i);
			}
			return lRet;
		}
		else 
		{
			return HWL_ENCODER_GetTsBitrate(0, TsIndex);
		}
	}
	else if (CHNIndex == 1) 
	{
		if (plHandle->m_Configuration.m_IpOutputType == IP_OUTPUT_SPTS) 
		{ /* SPTS 输入与输出相同 */
			if (TsIndex == -1) 
			{
				for (i = 0; i < MULT_MAX_CHN_NUM; i++) 
		...
		else if (plHandle->m_Configuration.m_IpOutputType == IP_OUTPUT_MPTS) 
		{ /* MPTS 输出等于所有通道码率之和 */
			if (TsIndex == 0 || TsIndex == -1)
			{
				for (i = 0; i < MULT_MAX_CHN_NUM; i++) 
				{
					lRet += HWL_ENCODER_GetTsBitrate(0, i);
...
#elif defined(GN1846)|| defined(GN1866) || defined(GN1866B)
	ICPL_ByteInfo_t ByteArray[] =
	{
...
/*TD 接口 ---------------------------------------------------------------------------------------------------------------------------------------- */
#if defined(GQ3650DR) || defined(GQ3710A) || defined(GQ3710B) || defined(GQ3655) || defined(GQ3760A) || defined(GQ3760)
...
BOOL HWL_GetHWInfo(HWL_HWInfo *pHWInfo)
{
	...
	pHWInfo->m_ChipID = AUTHL_Fpga_ID();
	...
	pHWInfo->m_pInfoList[lChnInd].m_Direction = HWL_CHANNEL_DIRECTION_IN;
	pHWInfo->m_pInfoList[lChnInd].m_Type = HWL_CHANNEL_TYPE_ENCODER;
	pHWInfo->m_pInfoList[lChnInd].m_SubType = HWL_CHANNEL_SUBTYPE_ENCODER_HI3519;
	pHWInfo->m_pInfoList[lChnInd].m_StartTsIndex = 0;
	pHWInfo->m_pInfoList[lChnInd].m_CurSubSupport = 2;
