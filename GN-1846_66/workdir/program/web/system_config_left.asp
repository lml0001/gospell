...
<head>
    ...
    <script type="text/javascript">
        ...
        function OnLoad() 
        {
			...
			if (JS_InfoIsSupportWM() == true)
            {
				lTmpStr = "<a href='system_config_right_osd.html' target='right_frame'>" + JS_LAN("osd") + "</a>";
				TreeItem.AddNewNode(lRootID, lTmpStr);
			}
			...
			// if ((JS_InfoGetSN().substr(0,7) != "TC41A07") && (JS_InfoGetSN().substr(0,7) != "TC41A08") && (JS_InfoGetSN().substr(0,7) != "TC41A09"))
			//{
...
<body onload="OnLoad()">
    <table class="chrome_center" width="310px" height="560px" border="0" align="center" cellpadding="0" cellspacing="0"
        id="Table1">
        <tr>
