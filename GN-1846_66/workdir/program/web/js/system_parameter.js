...
function JS_ParamGetChannelInfoEncoderNewLimits(Obj)
{
	...
	lSubInfo.m_x_coordinateLimitLow = JS_XMLGetTagValue(Obj, "x_coordinateLimitLow");
	lSubInfo.m_x_coordinateLimitHigh = JS_XMLGetTagValue(Obj, "x_coordinateLimitHigh");

	lSubInfo.m_y_coordinateLimitLow = JS_XMLGetTagValue(Obj, "y_coordinateLimitLow");
	lSubInfo.m_y_coordinateLimitHigh = JS_XMLGetTagValue(Obj, "y_coordinateLimitHigh");

	lSubInfo.m_transparentLimitLow = JS_XMLGetTagValue(Obj, "transparentLimitLow");
	lSubInfo.m_transparentLimitHigh = JS_XMLGetTagValue(Obj, "transparentLimitHigh");

	/* Mosaic */
	lSubInfo.m_Mosaic_x_coordinateLimitLow = JS_XMLGetTagValue(Obj, "Mosaic_x_coordinateLimitLow");
	lSubInfo.m_Mosaic_x_coordinateLimitHigh = JS_XMLGetTagValue(Obj, "Mosaic_x_coordinateLimitHigh");

	lSubInfo.m_Mosaic_y_coordinateLimitLow = JS_XMLGetTagValue(Obj, "Mosaic_y_coordinateLimitLow");
	lSubInfo.m_Mosaic_y_coordinateLimitHigh = JS_XMLGetTagValue(Obj, "Mosaic_y_coordinateLimitHigh");

	lSubInfo.m_Mosaic_Width_LimitLow = JS_XMLGetTagValue(Obj, "Mosaic_Width_LimitLow");
	lSubInfo.m_Mosaic_Width_LimitHigh = JS_XMLGetTagValue(Obj, "Mosaic_Width_LimitHigh");

	lSubInfo.m_Mosaic_Height_LimitLow = JS_XMLGetTagValue(Obj, "Mosaic_Height_LimitLow");
	lSubInfo.m_Mosaic_Height_LimitHigh = JS_XMLGetTagValue(Obj, "Mosaic_Height_LimitHigh");
	return lSubInfo;
}
...
function JS_ParamGetSubChannelInfoEncoderNew(Obj) {
    ...
    lSubInfo.m_AudioGroup = JS_XMLGetTagValue(Obj, "audio_group");
	
    lSubInfo.m_AudEncMode = JS_XMLGetTagValue(Obj, "aud_enc_mode");
    lSubInfo.m_AudBitrate = JS_XMLGetTagValue(Obj, "aud_bitrate");

    lSubInfo.m_x_coordinate = JS_XMLGetTagValue(Obj, "x_coordinate");
    lSubInfo.m_y_coordinate = JS_XMLGetTagValue(Obj, "y_coordinate");
    lSubInfo.m_transparent = JS_XMLGetTagValue(Obj, "transparent");
    lSubInfo.m_enable = JS_XMLGetTagValue(Obj, "enable");	

    lSubInfo.m_mosaic_x_coordinate = JS_XMLGetTagValue(Obj, "mosaic_x_coordinate");
    lSubInfo.m_mosaic_y_coordinate = JS_XMLGetTagValue(Obj, "mosaic_y_coordinate");
    lSubInfo.m_mosaic_width = JS_XMLGetTagValue(Obj, "mosaic_width");
    lSubInfo.m_mosaic_height = JS_XMLGetTagValue(Obj, "mosaic_height");
    lSubInfo.m_mosaic_size = JS_XMLGetTagValue(Obj, "mosaic_size");
    lSubInfo.m_mosaic_enable = JS_XMLGetTagValue(Obj, "mosaic_enable");	
